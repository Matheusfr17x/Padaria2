...
public class FormEndereco extends javax.swing.JDialog {
    DAOCliente objDAOCliente = new DAOCliente();

    /**
     * Creates new form FormEndereco
     */
    public FormEndereco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        atualizaTabela();
        trataEdicao(false);  
    ...
    public boolean validaCampos(){
        ...
        if(!(txtNome.getText().length() > 0)){
            ...
            JOptionPane.showMessageDialog(null, "Numero da casa");
            return false;
        }
    ...
    private void initComponents() {
        ...
        lblTelefone.setText("Cidade");

        lblCpf.setText("Numero");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormEndereco dialog = new FormEndereco(new javax.swing.JFrame(), true);
